...
UPDATE O2D_DDL_4.O2D_DDL_4_NUMBERTYPES set s_integer=12839 where S_PK_FORMAPPING=2;
UPDATE O2D_DDL_4.O2D_DDL_4_CHARTYPES set s_char_mid='ch' where S_PK_FORMAPPING=2;
UPDATE O2D_DDL_4.O2D_DDL_4_DATATYPES set s_date=TO_DATE('2012.03.09','yyyy.mm.dd') where S_PK_FORMAPPING=2;
UPDATE O2D_DDL_4.O2D_DDL_4_RAWLOBTYPES set S_RAW_MAX=hextoraw('53bc') where S_PK_FORMAPPING=2;
commit;
