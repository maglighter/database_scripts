...
CREATE TABLE  TAR_USER.ORA_NUMBERTYPES
(
...
CREATE TABLE  TAR_USER.ORA_CHARTYPES
(
...
CREATE TABLE  TAR_USER.ORA_DATATYPES
(
  S_DATE                     DATE,
...
CREATE TABLE  TAR_USER.ORA_RAWLOBTYPES
(
--  S_LONG           LONG,
  S_RAW_MAX            RAW(2000),
  S_RAW_MID            RAW(1000),
...
ALTER TABLE  TAR_USER.ORA_NUMBERTYPES ADD (
  CONSTRAINT ORA_NUMBERTYPES_PK
 PRIMARY KEY
 (S_PK_FORMAPPING));

ALTER TABLE  TAR_USER.ORA_DATATYPES ADD (
  CONSTRAINT ORA_DATATYPES_PK
 PRIMARY KEY
 (S_PK_FORMAPPING));

ALTER TABLE  TAR_USER.ORA_RAWLOBTYPES ADD (
  CONSTRAINT ORA_RAWLOBTYPES_PK
 PRIMARY KEY
 (S_PK_FORMAPPING));

ALTER TABLE  TAR_USER.ORA_CHARTYPES ADD (
  CONSTRAINT ORA_CHARTYPES_PK
 PRIMARY KEY
 (S_PK_FORMAPPING));
 
 
CREATE OR REPLACE TRIGGER  TAR_USER.ORA_PK_TRG_NUMBERTYPES
BEFORE INSERT
ON  TAR_USER.ORA_NUMBERTYPES 
...
BEGIN
   tmpVar := 0;
    ...
    THEN  
        SELECT  TAR_USER.ORA_PK_ID.NEXTVAL INTO tmpVar FROM dual;
   ...
   EXCEPTION
     WHEN OTHERS THEN
       ...
       RAISE;
END TAR_USER.ORA_PK_TRG_NUMBERTYPES;
/
--show errors


CREATE OR REPLACE TRIGGER  TAR_USER.ORA_PK_TRG_RAWLOBTYPES
BEFORE INSERT
ON  TAR_USER.ORA_RAWLOBTYPES 
REFERENCING NEW AS NEW OLD AS OLD
FOR EACH ROW
DECLARE
tmpVar NUMBER;
BEGIN
   ...
   EXCEPTION
     WHEN OTHERS THEN
       -- Consider logging the error and then re-raise
       RAISE;
END TAR_USER.ORA_PK_TRG_RAWLOBTYPES;
/
--show errors


CREATE OR REPLACE TRIGGER  TAR_USER.ORA_PK_TRG_CHARTYPES
BEFORE INSERT
ON  TAR_USER.ORA_CHARTYPES 
REFERENCING NEW AS NEW OLD AS OLD
FOR EACH ROW
DECLARE
tmpVar NUMBER;
BEGIN
   ...
   EXCEPTION
     WHEN OTHERS THEN
       -- Consider logging the error and then re-raise
       RAISE;
END TAR_USER.ORA_PK_TRG_CHARTYPES;
/
--show errors


CREATE OR REPLACE TRIGGER  TAR_USER.ORA_PK_TRG_DATATYPES
BEFORE INSERT
ON  TAR_USER.ORA_DATATYPES 
REFERENCING NEW AS NEW OLD AS OLD
FOR EACH ROW
DECLARE
tmpVar NUMBER;
BEGIN
   ...
   EXCEPTION
     WHEN OTHERS THEN
       -- Consider logging the error and then re-raise
       RAISE;
END TAR_USER.ORA_PK_TRG_DATATYPES;
/
--ppshow errors
