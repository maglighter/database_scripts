...
ALTER TABLE ORA_NUMBERTYPES ADD (
  CONSTRAINT ORA_NUMBERTYPES_PK
 PRIMARY KEY
 (S_PK_FORMAPPING));

ALTER TABLE ORA_DATATYPES ADD (
  CONSTRAINT ORA_DATATYPES_PK
 PRIMARY KEY
 (S_PK_FORMAPPING));

ALTER TABLE ORA_RAWLOBTYPES ADD (
  CONSTRAINT ORA_RAWLOBTYPES_PK
 PRIMARY KEY
 (S_PK_FORMAPPING));

ALTER TABLE ORA_CHARTYPES ADD (
  CONSTRAINT ORA_CHARTYPES_PK
 PRIMARY KEY
 (S_PK_FORMAPPING));
 
 
CREATE OR REPLACE TRIGGER ORA_PK_TRG_NUMBERTYPES
BEFORE INSERT
ON ORA_NUMBERTYPES 
...
CREATE OR REPLACE TRIGGER ORA_PK_TRG_RAWLOBTYPES
BEFORE INSERT
ON ORA_RAWLOBTYPES 
REFERENCING NEW AS NEW OLD AS OLD
FOR EACH ROW
...
CREATE OR REPLACE TRIGGER ORA_PK_TRG_CHARTYPES
BEFORE INSERT
ON ORA_CHARTYPES 
REFERENCING NEW AS NEW OLD AS OLD
FOR EACH ROW
...
CREATE OR REPLACE TRIGGER ORA_PK_TRG_DATATYPES
BEFORE INSERT
ON ORA_DATATYPES 
REFERENCING NEW AS NEW OLD AS OLD
FOR EACH ROW
