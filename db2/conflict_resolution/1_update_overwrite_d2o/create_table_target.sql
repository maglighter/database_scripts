...
CREATE TABLE "CONFLICTS"."D2O_CONFLICT_1_01"
...
CREATE TABLE "CONFLICTS"."D2O_CONFLICT_1_11"
...
CREATE TABLE "CONFLICTS"."D2O_CONFLICT_1_12"
(S_INTEGER NUMBER(10,0) NOT NULL/*DB2 datatype: INTEGER(4, 0)*/,
...
/*
CREATE TABLE "D2O_CONFLICT_1_13"
(S_INTEGER NUMBER(10,0) NOT NULL,
S_LONG_VARGRAPHIC CLOB,
PRIMARY KEY (S_INTEGER)
);

CREATE TABLE "D2O_CONFLICT_1_14"
(S_INTEGER NUMBER(10,0) NOT NULL,
S_LONG_VARCHAR CLOB,
PRIMARY KEY (S_INTEGER)
);

CREATE TABLE "D2O_CONFLICT_1_15"
(S_INTEGER NUMBER(10,0) NOT NULL,
S_CLOB CLOB,
PRIMARY KEY (S_INTEGER)
);

CREATE TABLE "D2O_CONFLICT_1_16"
(S_INTEGER NUMBER(10,0) NOT NULL,
S_DBCLOB CLOB,
PRIMARY KEY (S_INTEGER)
);

CREATE TABLE "D2O_CONFLICT_1_17"
(S_INTEGER NUMBER(10,0) NOT NULL,
S_BLOB BLOB,
PRIMARY KEY (S_INTEGER)
);
